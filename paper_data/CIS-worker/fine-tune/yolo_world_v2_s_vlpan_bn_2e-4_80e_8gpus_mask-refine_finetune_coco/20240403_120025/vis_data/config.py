...
launcher = 'none'
load_from = 'work_dirs/yolo_world_v2_s_vlpan_bn_2e-4_80e_8gpus_mask-refine_finetune_coco/epoch_80.pth'
log_level = 'INFO'
...
weight_decay = 0.05
widen_factor = 0.5
work_dir = './work_dirs/yolo_world_v2_s_vlpan_bn_2e-4_80e_8gpus_mask-refine_finetune_coco'
