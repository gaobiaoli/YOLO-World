...
coco_train_dataset = dict(
    ...
    pipeline=[
        ...
        dict(prob=0.1, type='YOLOv5CopyPaste'),
        dict(
            border=(
                -320,
                -320,
...
launcher = 'none'
load_from = 'work_dirs/yolo_world_v2_m_vlpan_bn_2e-4_80e_8gpus_mask-refine_finetune_coco/epoch_80.pth'
log_level = 'INFO'
...
weight_decay = 0.05
widen_factor = 0.75
work_dir = './work_dirs/yolo_world_v2_m_vlpan_bn_2e-4_80e_8gpus_mask-refine_finetune_coco'
