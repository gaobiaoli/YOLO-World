...
coco_val_dataset = dict(
    _delete_=True,
    class_text_path='data/texts/cis_class_texts_fine.json',
    dataset=dict(
...
launcher = 'none'
load_from = 'pretrained_weights/yolo_world_v2_s_obj365v1_goldg_pretrain-55b943ea.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file='/CV/gaobiaoli/dataset/CIS-Dataset/annotations/test.json',
    metric='bbox',
    proposal_nums=(
        100,
        1,
...
weight_decay = 0.025
widen_factor = 0.5
work_dir = './work_dirs/yolo_world_v2_s_vlpan_bn_2e-3_100e_4x8gpus_obj365v1_goldg_train_lvis_minival'
