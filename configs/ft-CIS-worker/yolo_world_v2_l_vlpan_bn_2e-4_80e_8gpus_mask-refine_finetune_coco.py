...
load_from = 'pretrained_weights/yolo_world_v2_l_obj365v1_goldg_pretrain-a82b1fe3.pth'
...
val_evaluator = dict(
    ...
    ann_file='/CV/gaobiaoli/dataset/CIS-Dataset/annotations/CIS-worker-val.json',
    metric='bbox')
...
test_evaluator = dict(
    ...
    type='mmdet.CocoMetric',
    proposal_nums=(100, 1, 10),
    ann_file='/CV/gaobiaoli/dataset/CIS-Dataset/annotations/CIS-worker-test.json',
    metric='bbox')